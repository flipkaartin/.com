    ...
    var m = "day"
      ...
      , c = {
        ...
        _perSecondHandler: function() {
            ...
            c._applyEffectSwitch.apply(this, [t.effectType])) : (e = l.extend(e, e.data("syotimer-blocks")),
            t.afterDeadline(e))
        },
        ...
        _applyEffectSwitch: function(e, t) {
            ...
            }, 1e3) : "opacity" !== e || (i = a.data("syotimer-items")[t]) && (n = u.next(t),
      ...
      , y = {
        ...
        getSecondsToDeadLine: function(e, t) {
            var i, n, o, r, a = e / 1e3, a = Math.floor(a), s = t.periodic ? (r = e / (1e3 * (o = y.getPeriodUnit(t.periodUnit))),
            r = Math.ceil(r),
            r = Math.abs(r),
            0 <= a ? (n = 0 === (n = r % t.periodInterval) ? t.periodInterval : n,
            --n) : n = t.periodInterval - r % t.periodInterval,
            0 == (i = a % o) && a < 0 && n--,
            Math.abs(n * o + i)) : a;
            return s
        },
        ...
        getDifferenceWithTimezone: function(e, t, i) {
            var n = t.getTime() - e.getTime()
              , o = 0
              , r = 0;
            return "local" !== i.timeZone && (o = 1e3 * (parseFloat(i.timeZone) * y.getPeriodUnit(a) - -e.getTimezoneOffset() * y.getPeriodUnit(s))),
